...
- [x] Fase 1 — Equipo de agentes creado y configurado (idioma, estrategia, mejora continua).
- [ ] Fase 2 — Backend: tabla de chat + estrategia/estado + campos de outreach en Oportunidad + notif a 2 mails.
- [ ] Fase 3 — Scheduled cloud agent diario que ejecuta el ciclo.
- [ ] Fase 4 — Interfaz de chat persistente + vista de seguimiento en CRM.jsx.
- [ ] Fase 5 — n8n: envío de mails + escucha de respuestas.
