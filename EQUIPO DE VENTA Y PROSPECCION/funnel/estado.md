...
**Próximo bloqueante:** Validar calidad de los emails y activar envío real (`OUTREACH_ENABLED=true` + warm-up). Candidatos prioritarios ⭐: Fulleri (Avellaneda, jfulleri@ nominativo, 45 años, PyMES ⭐), GQM (Quilmes, 200+ clientes ⭐), D'Ambrosio (Quilmes + Puerto Madero, doble sede), Mascheroni (Lomas, dominio propio, titular identificada), Domínguez (Morón, Hernán verificado LinkedIn), Bocco (Villa María, dominio propio, agro), SAIPE (multi-sucursal, alfiore@), Fernández Carrera Molejón (ISO 9001, General Roca ⭐⭐), Poszler (Venado Tuerto, Gmail personal ⭐⭐). Candidatos sin nombre para mejorar copy: Gestión Sur (Quilmes, llamar 11-4164-2531), Vitacca (Avellaneda, llamar 011-42704478). Alerta: Robledo (Morón, sitio 503) — validar email antes del envío real.
