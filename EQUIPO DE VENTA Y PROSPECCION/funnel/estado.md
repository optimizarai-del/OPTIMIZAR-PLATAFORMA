...
**Próximo bloqueante:** Validar calidad de los emails y activar envío real (`OUTREACH_ENABLED=true` + warm-up). Candidatos prioritarios ⭐: Mascheroni (Lomas, dominio propio, titular identificada), Domínguez (Morón, Hernán verificado LinkedIn, dominio propio), Morgado (Morón, multi-sede, agro, 1987), Bocco (Villa María, dominio propio, agro), SAIPE (multi-sucursal, email personal alfiore@), LS S.A. (José Sasia, 70 años), Fernández Carrera Molejón (ISO 9001, General Roca ⭐⭐), Poszler (Venado Tuerto, Gmail personal ⭐⭐). Candidatos sin email para corrida futura: Asociados Contables (Lomas, "3 generaciones", buscar nombre socio CPBA), LAR Estudio Contable (Lomas, lar.estudiocontable1@gmail.com sin nombre personal), Estudio Zurano (Lomas), Bettiolo-Parodi-Lázaro ⭐ (San Nicolás, CPBA), Secondi ⭐ (Olavarría, CPBA), Melnik ⭐⭐ (Catamarca, CPCE). Alerta: Robledo (Morón, sitio 503) — validar email antes del envío real.
