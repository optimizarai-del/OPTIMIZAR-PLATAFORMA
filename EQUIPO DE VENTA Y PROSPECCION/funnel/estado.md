...
**Segmento:** Estudios contables/impositivos — **Mar del Plata (2ª wave, Buenos Aires)** (~650k hab, 38 días desde 1ª corrida)
**Cupo usado:** 5 leads
**Leads encontrados:** 8+ (candidatos evaluados desde sitios propios + directorios)
**Leads descartados:** 3 (Estudio BDR — sede CABA no MdP; Estudio Mar del Plata — email protegido JS; GC Consultora — sin nombre de titular)
**Emails escritos:** 5/5 ✅ (González Patrón, Ricardo Panza, Planners&Doers/Lázaro, Bruschetti, RUA|LAREU/Lareu)
**Sin email:** 0
**Email status:** 2 verified_gmail (González Patrón ngonzalezpatron@gmail.com, Bruschetti leandro.bruschetti@gmail.com) + 3 verified_domain (ricardopanza.com.ar, plannersdoers.com.ar, rualareu.com)
**CRM:** 5/5 × HTTP 200 confirmado
**Disparador:** Prórroga DDJJ Ganancias/Bienes Personales período 2025 hasta 27/07/2026 (RG ARCA 5851/2026) — quedan **7 días**.
**Archivos:**
- `funnel/leads/new/borrador-2026-07-20.jsonl` — 5 leads
- `funnel/reportes/2026-07-20.md` — reporte completo
**Total acumulado borrador:** 200 leads (40 corridas) 🎯 HITO REDONDO
**Hitos:** Bragado (PBA Oeste) inaugurado ✓. 9 de Julio (PBA Oeste) inaugurado ✓. **HITO: 200 leads en borrador (40 corridas)**. PBA Oeste continuado. Candidatos ⭐: Acosta (único email Bragado). Pendientes Bragado: Vives, Bagattin + email vía CPBA dlgbragado@cpba.com.ar. Pendientes 9 de Julio: Lespade, Falco, Fasciolo, Seisdedos + emails vía Cámara de Comercio camaradecomercio@internueve.com.ar.
**Próximo bloqueante:** Activar `OUTREACH_ENABLED=true` + warm-up. **ALERTA TIMING CRÍTICA:** quedan 7 días para el 27/07/2026. Con 200 leads en Contactos (≥166 con email válido). Ventana de acción: HOY.
