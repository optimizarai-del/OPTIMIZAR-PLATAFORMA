...
from app.routers import (auth, users, proyectos, tareas, tiempo, requerimientos,
                         dashboard, notificaciones, crm, ads, servicios, agentes, gero)
...
for r in [auth, users, proyectos, tareas, tiempo, requerimientos, dashboard, notificaciones, crm, ads, servicios, agentes, gero]:
