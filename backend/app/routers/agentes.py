...
CATALOGO = [
    ...
    {"area": "Marketing", "agente": "investigacion", "nombre": "Investigador",
     ...
     "mcps": ["Playwright", "Google Trends", "Claude"], "requiere": None, "listo": True},
    ...
    {"area": "Marketing", "agente": "creativo", "nombre": "Creativo",
     "rol": "Imágenes (ChatGPT Images) y video/reels (Higgsfield) on-brand.",
     "mcps": ["ChatGPT Images (OpenAI)", "Higgsfield"], "requiere": "OpenAI (imágenes) + Higgsfield (video/reels) para generar (deja prompts sin ellas).", "listo": True},
    {"area": "Marketing", "agente": "programador", "nombre": "Programador",
     "rol": "Publica las piezas aprobadas y gestiona el calendario.",
     "mcps": ["Instagram Graph API", "LinkedIn API", "n8n"], "requiere": "Tokens IG/LinkedIn para publicar.", "listo": False},
    {"area": "Marketing", "agente": "metricas", "nombre": "Métricas",
     "rol": "Performance de cada pieza; detecta qué funciona.",
     "mcps": ["Meta API", "LinkedIn API", "Supabase"], "requiere": "Acceso a métricas de IG/LinkedIn.", "listo": False},
    ...
    {"area": "Comercial", "agente": "sdr", "nombre": "Prospección (SDR)",
     ...
     "mcps": ["Apollo", "Instantly", "Claude"], "requiere": "Apollo + Instantly para envío real.", "listo": True},
    {"area": "Comercial", "agente": "calificacion", "nombre": "Calificador",
     "rol": "Atiende entrantes (WhatsApp, IG DM), califica y pasa al pipeline.",
     "mcps": ["WhatsApp WATI", "Instagram DM"], "requiere": "WhatsApp API (WATI).", "listo": False},
    {"area": "Comercial", "agente": "agenda", "nombre": "Agenda",
     "rol": "Agenda reuniones de diagnóstico con leads calificados.",
     "mcps": ["Google Calendar", "n8n"], "requiere": "Google Calendar.", "listo": False},
    {"area": "Comercial", "agente": "crm", "nombre": "CRM",
     "rol": "Actualiza el pipeline y genera alertas de seguimiento.",
     "mcps": ["Supabase", "Notion", "n8n"], "requiere": None, "listo": True},
