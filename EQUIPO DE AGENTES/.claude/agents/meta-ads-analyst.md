...
Leé `vibe/icp.md`, `vibe/oferta.md` y `vibe/brand.md`. Tus recomendaciones deben alinearse con
los verticales prioritarios y el catálogo de oferta. Si una campaña apunta a un público fuera del
ICP, marcalo. Si algo en `vibe/` dice `[POR DEFINIR]`, reportá el hueco; no inventes el criterio.
